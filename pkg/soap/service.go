...
type ITransactionProcessor interface {
	RunTransaction(request *RequestMessage) (*ReplyMessage, error)

	RunTransactionContext(ctx context.Context, request *RequestMessage) (*ReplyMessage, error)
}

type iTransactionProcessor struct {
	client *soap.Client
}

func NewITransactionProcessor(client *soap.Client) ITransactionProcessor {
	return &iTransactionProcessor{
		client: client,
	}
}

func (service *iTransactionProcessor) RunTransactionContext(ctx context.Context, request *RequestMessage) (*ReplyMessage, error) {
...
func (service *iTransactionProcessor) RunTransaction(request *RequestMessage) (*ReplyMessage, error) {
